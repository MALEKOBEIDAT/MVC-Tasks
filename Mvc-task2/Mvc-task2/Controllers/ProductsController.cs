...
namespace Mvc_task2.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Productid,ProductName,Unitprice,Unitsstock,Categoryid")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Productid,ProductName,Unitprice,Unitsstock,Categoryid")] Product product)
        {
            if (ModelState.IsValid)
            {
